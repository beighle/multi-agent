...
function uiShowPorts {
	...
	if myPort <> 0 {
		...
		set ui_myPort:show to false.//jb changed from true to false because I don't want to see the vecDraws
	} else {
	...
	if hisPort <> 0 {
		...
		set ui_hisPort:show to false.//jb changed from true to false because I don't want to see the vecDraws
	} else {
